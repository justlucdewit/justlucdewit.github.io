...
Before i started with this projec, I had a different portfolio/blogging site developed by me using VueJS, However I was not really happy with the design and the mobile compatibility, and overall it was a pain in the ass to use and maintain

## Jeckyll
Due to that I decided to checkout Jeckyll, a static site generator made in ruby.

My first impressions of it were pretty bad due to me having trouble setting up ruby and its package manager on windows, but after switching over to WSL ubuntu, i finally got it working!
